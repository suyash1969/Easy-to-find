        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                $name1=mysqli_real_escape_string($con, $_POST['name']);
                 ...
                 $query1= "UPDATE institution SET profile='$profile',Bio='$Bio',phone='$phone' WHERE name='$name' ";
                 $query3= "UPDATE registration SET name='$name1', email='$email' WHERE name='$name' ";
